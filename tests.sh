...
then
        ...
        validate "$(build_command_sequence 'echo bash "scripting" is "~fun" ,~seriously ":)"' 'exit')" "$P bash scripting is ~fun ,~seriously :)\n$PEND"
        validate "$(build_command_sequence 'echo bash "scripting" is "~fun" ,~seriously ":)"' 'history' 'exit')" "$P bash scripting is ~fun ,~seriously :)\n$P echo bash \"scripting\" is \"~fun\" ,~seriously \":)\" DONE\nhistory RUNNING\n$PEND"
